...
class Contact(models.Model):
    ...
    rank = models.ForeignKey(Rank, on_delete=models.PROTECT, verbose_name='Звание', null=True, default=None)
    ...
    status = models.IntegerField('Статус', choices=STATUS_CONTACT_CHOICES, default=0)

    def __str__(self):
        if self.rank is None:
            return str(self.sur_name) + " " + str(self.name) + " " + str(self.patronymic)
        else:
