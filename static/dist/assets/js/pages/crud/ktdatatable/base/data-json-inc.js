...
var KTDatatableJsonRemoteDemo = function () {
    ...
    var demo = function () {
        ...
        $('#kt_datepicker').on('change', function () {
            datatable.search($(this).val(), 'date_time');
        });

        $('#kt_datatable_search_subject, #kt_datatable_search_region').selectpicker();
